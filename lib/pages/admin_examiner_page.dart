...
import 'package:gradefy/pages/widgets/widget_confirm_delete.dart';
import 'package:gradefy/pages/widgets/widget_searchbar.dart';
...
class AdminExaminerListPage extends StatelessWidget {
  const AdminExaminerListPage({super.key});
      ...
      return Expanded(
        child: Column(
          children: [
            ...
            Expanded(
              child: FutureBuilder(
                  future: provider.loadExaminer(),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      if (provider.filterExaminerList.isNotEmpty) {
                        return ListView(
                          children: List.generate(provider.filterExaminerList.length,
                                  (index) {
                                final item = provider.filterExaminerList[index];
...
class AdminExaminerAddPage extends StatelessWidget {
  const AdminExaminerAddPage({super.key});
...
class AdminExaminerEditPage extends StatelessWidget {
  const AdminExaminerEditPage({super.key});
              ...
              children: [
                ...
                Expanded(
                  child: provider.teacher == null
                      ? FutureBuilder(
                      future: provider.loadExaminers(),
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          if (provider.filterExaminerList.isNotEmpty) {
                            return ListView(
                              children: List.generate(
                                  provider.filterExaminerList.length, (index) {
                                final item = provider.filterExaminerList[index];
                                return Stack(
...
class AdminExaminerDeletePage extends StatelessWidget {
  const AdminExaminerDeletePage({super.key});
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  if (provider.filterExaminerList.isNotEmpty) {
                    return ListView(
                      children:
                      List.generate(provider.filterExaminerList.length, (index) {
                        final item = provider.filterExaminerList[index];
                        return Stack(
                          alignment: Alignment.centerLeft,
                          children: [
